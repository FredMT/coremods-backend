...
public class ModDetailsRequest {
     ...
     * - A subcategory under a main category (e.g., "Textures" under "Graphics &
     * Visuals")
     * 
    ...
    /**
     * Name for a new subcategory to be created under the main category specified by
     * categoryId.
     * This is only used when the user wants to create a custom subcategory.
     * The system will validate that this name doesn't already exist as a
     * subcategory
