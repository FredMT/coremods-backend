...
public class ModMediaController {
        ...
        public ResponseEntity<ApiResponse<ImageUploadResponse>> uploadHeaderImage(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Header image uploaded successfully", uploadResponse));
        }
        ...
        public ResponseEntity<ApiResponse<ImageUploadResponse>> uploadModImage(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Mod image uploaded successfully", uploadResponse));
        }
        ...
        public ResponseEntity<ApiResponse<List<ImageResponse>>> getImages(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Images retrieved successfully", imageResponses));
        }
        ...
        public ResponseEntity<ApiResponse<List<ImageResponse>>> getModImages(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Mod images retrieved successfully", imageResponses));
        }
        ...
        public ResponseEntity<ApiResponse<Void>> deleteImage(
                ...
                return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("Image deleted successfully"));
        }
        ...
        public ResponseEntity<ApiResponse<ImageResponse>> updateImageName(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Image name updated successfully", imageResponse));
        }
        ...
        public ResponseEntity<ApiResponse<List<YouTubeVideoResponse>>> addYouTubeVideos(
                ...
                List<YouTubeVideoResponse> videoResponses = modMediaService.addYouTubeVideos(gameModId, requests,
                                currentUser);
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("YouTube videos added successfully", videoResponses));
        }
        ...
        public ResponseEntity<ApiResponse<List<YouTubeVideoResponse>>> getYouTubeVideos(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("YouTube videos retrieved successfully", videoResponses));
        }
        ...
        public ResponseEntity<ApiResponse<YouTubeVideoResponse>> updateYouTubeVideo(
                ...
                YouTubeVideoResponse videoResponse = modMediaService.updateYouTubeVideo(gameModId, videoId, request,
                                currentUser);
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("YouTube video updated successfully", videoResponse));
        }
        ...
        public ResponseEntity<ApiResponse<Void>> deleteYouTubeVideo(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("YouTube video deleted successfully"));
        }
}