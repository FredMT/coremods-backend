...
public class ModMediaController {
        ...
        public ResponseEntity<ApiResponse<Image>> uploadHeaderImage(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Header image uploaded successfully", image));
        }
        ...
        public ResponseEntity<ApiResponse<Image>> getHeaderImage(
                ...
                ApiResponse<Image> response = image.map(value -> ApiResponse.success("Header image retrieved successfully", value)).orElseGet(() -> ApiResponse.success("No header image found", null));
        ...
        public ResponseEntity<ApiResponse<List<Image>>> getModImages(
                ...
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ApiResponse.success("Mod images retrieved successfully", images));
        }
